...
% (Note: This looks like a final error constraint from the steadyState equation)
...
% Add t=7s vertical line to the Input plot as well
hold on;
u_response = step_ru*wsol;
line([t_settle t_settle], [min(u_response) max(u_response)], ...
     'Color', 'r', 'LineStyle', ':', 'LineWidth', 1);
hold off;
