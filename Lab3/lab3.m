...
% realWPoles = [];
% complexWPoles = [
%     -0.189985840382028-0.0810681634243754j,
%     -0.189985840382028+0.0810681634243754j,
%     0.0865690591666256-0.278996651105956j,
%     0.0865690591666256+0.278996651105956j,
%     0.354107593324115-0.0510667440728613j,
%     0.354107593324115+0.0510667440728613j,
%     0.285851078344817+0.298254635631656j,
%     0.285851078344817-0.298254635631656j,
%     % -0.0335366649247514+0.460661074369279j,
%     % -0.0335366649247514-0.460661074369279j,
%     % -0.373105154102088+0.341749241378027j,
%     % -0.373105154102088-0.341749241378027j,
%     % -0.545930111618406+0.0250395665893242j,
%     % -0.545930111618406-0.0250395665893242j,
%     % -0.481618807456276-0.33072141998626j,
%     % -0.481618807456276+0.33072141998626j,
%     % -0.218789925589103-0.579768029871185j,
%     % -0.218789925589103+0.579768029871185j,
%     % 0.138980235182067-0.638240676309027j,
%     % 0.138980235182067+0.638240676309027j,
%     % 0.472736998985008-0.495835721911987j,
%     % 0.472736998985008+0.495835721911987j,
%     % 0.686385524361844-0.202175448426647j,
%     % 0.686385524361844+0.202175448426647j,
%     % 0.727616254232878+0.15887496103157j,
%     % 0.727616254232878-0.15887496103157j,
%     % 0.592389217879663+0.496395354403377j,
%     % 0.592389217879663-0.496395354403377j,
%     % 0.317271419695522+0.734396926902876j,
%     % 0.317271419695522-0.734396926902876j
% ];
complexWPoles = generate_poles(100, 0.9,0)

ps = [realWPoles complexWPoles];
% ps = generate_poles(30, 0.8, 0);  % Your generated poles
