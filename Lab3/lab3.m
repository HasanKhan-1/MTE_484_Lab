...
% CONTINUOUS OUTER PLANT
G_C = -0.231035423/(s^2); % K2 * K3 / s^2
...
% complexWPoles = generate_poles(50, 0.9, 0)
realWPoles = [];
complexWPoles = [
    % -0.8,
    % -0.715789473684211,
    ...
    % 0.715789473684211,
    % 0.8,
    % -0.165557699058333-0.0706445205413011j,
    % -0.165557699058333+0.0706445205413011j,
    0.0754381180010667-0.243123611260727j,
    0.0754381180010667+0.243123611260727j,
    % 0.308576882634724-0.0445006461013263j,
    % 0.308576882634724+0.0445006461013263j,
    % 0.249096704833104+0.259905428264377j,
    % 0.249096704833104-0.259905428264377j,
    -0.0292245625667026+0.401429850587602j,
    -0.0292245625667026-0.401429850587602j,
    % -0.325131760849846+0.297807552098126j,
    % -0.325131760849846-0.297807552098126j,
    % -0.47573510186053+0.0218200104892585j,
    % -0.47573510186053-0.0218200104892585j,
    -0.419692864612147-0.288197674164192j,
    -0.419692864612147+0.288197674164192j,
    -0.190658191078025-0.505222182979781j,
    -0.190658191078025+0.505222182979781j,
    0.121110330670231-0.556176489798829j,
    0.121110330670231+0.556176489798829j,
    0.411953067946127-0.432081786019468j,
    0.411953067946127+0.432081786019468j,
    0.598130933609535-0.176179982572895j,
    0.598130933609535+0.176179982572895j,
    0.634060267891596+0.13844701759604j,
    0.634060267891596-0.13844701759604j,
    % 0.516220554447174+0.432569461666277j,
    % 0.516220554447174-0.432569461666277j,
    % 0.276477058059376+0.639969090165168j,
    % 0.276477058059376-0.639969090165168j,
    % -0.0305647960143267+0.719350952765479j,
    % -0.0305647960143267-0.719350952765479j,
    % -0.341964184485554+0.658680876091852j,
    % -0.341964184485554-0.658680876091852j,
    % -0.599440929875388+0.473149629176786j,
    % -0.599440929875388-0.473149629176786j,
    % -0.759018404664984+0.19872358033163j,
    % -0.759018404664984-0.19872358033163j,
    % -0.796496605740724-0.116589695271518j,
    % -0.796496605740724+0.116589695271518j,
    % -0.708827344963724-0.42185755301011j,
    % -0.708827344963724+0.42185755301011j,
    % -0.512064459621231-0.671260001186438j,
    % -0.512064459621231+0.671260001186438j,
    % -0.236887161413121-0.830111120728806j,
    % -0.236887161413121+0.830111120728806j,
    % 0.0772102928184333-0.878429604853395j,
    % 0.0772102928184333+0.878429604853395j,
    % 0.388044725412257-0.812047591634706j,
    % 0.388044725412257+0.812047591634706j
];
